      ...
      >
        ...
        <div className="mt-6 space-y-3 rounded-2xl border border-white/10 bg-black/20 p-4 text-sm leading-relaxed text-white/65">
          <p>
            ...
            full refund automatically via Paddle.
          </p>
          {!isGenesis ? (
            <p>
          ...
          >
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              {user.profileTier === 'bibliophile' ? (
                <>
                  Your existing Sage subscription should be cancelled and fully refunded in Paddle before you complete
                  Lifetime checkout. Ready to proceed? After you confirm, you&apos;ll pick your Genesis package (Lifetime
                  Deal only or + 1 Year Sage), then complete checkout in Paddle.
                </>
              ) : (
                <>
                  You&apos;ll choose your Genesis package next (Lifetime Deal only or + 1 Year Sage), then complete
                  checkout in Paddle. If you already have another paid Quilora subscription, cancel it for a full refund
            ...
            <p className="mt-4 text-xs text-white/40">
              Refund of your current pre-launch subscription is processed in Paddle when you cancel or migrate billing
        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              ...
              Paddle receipt, or email {SUPPORT} with the email you used at checkout and we&apos;ll help you complete
              cancellation (PAY-10).
            </p>
            <div className="mt-6 flex flex-wrap justify-end gap-2">
              <button
