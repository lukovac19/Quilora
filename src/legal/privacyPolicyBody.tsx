  ...
  return (
    <>
      ...
      <LegalSectionCard id="section-2" title="2. Data We Collect">
        ...
        <LegalParagraph>
          <strong>2.2 Payment and Billing Data</strong> — Payment transactions are processed exclusively by Paddle.com, our Merchant of Record. Quilora does not store, access, or process your full payment card details. We receive from Paddle only: order confirmation, subscription status, tier assignment, and transaction ID for credit allocation purposes.
        </LegalParagraph>
        <LegalParagraph>
      ...
      <LegalSectionCard id="section-4" title="4. How We Use Your Data">
        ...
        <LegalBulletList>
          ...
          <li>Processing payments and allocating subscription credits via Paddle webhooks;</li>
          <li>
      ...
      <LegalSectionCard id="section-6" title="6. Data Sharing and Third Parties">
        <LegalParagraph>
          <strong>6.1 Paddle (Payment Processor and Merchant of Record)</strong> — Paddle processes all payment transactions. Your billing data is collected and stored by Paddle under their own Privacy Policy (available at{' '}
          <a href="https://www.paddle.com/legal/privacy">paddle.com/legal/privacy</a>). Paddle provides Quilora with subscription status, tier assignments, and order confirmations only.
        </LegalParagraph>
        <LegalParagraph>
