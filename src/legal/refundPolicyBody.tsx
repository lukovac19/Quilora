    ...
    <>
      <LegalSectionCard id="section-1" title="1. Introduction">
        <LegalParagraph>
          ...
          <Link to="/payments">Payments and Subscriptions Agreement</Link> and <Link to="/terms">Terms of Service</Link>. Our order process is conducted by our online reseller Dodo Payments, which is the Merchant of Record for all orders and handles payment-related returns.
        </LegalParagraph>
      </LegalSectionCard>

      <LegalSectionCard id="section-2" title="2. Dodo Payments as Merchant of Record">
        <LegalParagraph>
          Quilora&apos;s refund policy complies with Dodo Payments reseller terms and applicable consumer protection law. Approved refunds are processed by Dodo Payments and may take 5–10 business days to appear on your statement.
        </LegalParagraph>
      </LegalSectionCard>
      ...
      <LegalSectionCard id="section-3" title="3. Subscription refunds">
        <LegalParagraph>
          ...
          with your Dodo Payments order number and a description of the issue.
        </LegalParagraph>
      </LegalSectionCard>
      ...
      <LegalSectionCard id="section-8" title="8. Billing disputes and chargebacks">
        ...
        <LegalParagraph>
          For disputes related to the payment transaction itself, you may also contact Dodo Payments support as Merchant of Record:{' '}
          <a href="https://dodopayments.com" className="font-semibold text-[#7bbdf3] underline underline-offset-2 hover:text-white">
