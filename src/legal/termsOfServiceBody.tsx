    ...
    <>
      <LegalSectionCard id="section-1" title="1. Introduction and Agreement">
        ...
        <LegalParagraph>
          ...
          <a href="https://quilora.app">https://quilora.app</a>, including all AI-powered analytical features, canvas tools, subscription services, credit systems, and related functionality (collectively, the &quot;Services&quot;). Our order process is conducted by our online reseller Dodo Payments. Dodo Payments is the Merchant of Record for all our orders.
        </LegalParagraph>
        <LegalParagraph>
      ...
      <LegalSectionCard id="section-3" title="3. User Accounts">
        <LegalParagraph>
          Account registration is completed through our third-party payment processor (Dodo Payments), which acts as Merchant of Record for all transactions. Your account is created and activated only upon successful payment confirmation via the Dodo Payments webhook system.
        </LegalParagraph>
      ...
      <LegalSectionCard id="section-8" title="8. Subscriptions, Payments, and Credits">
        <LegalParagraph>
          <strong>8.1 Payment Processor and Merchant of Record</strong> — All payments are processed exclusively through Dodo Payments, which acts as the Merchant of Record and authorized reseller for all Quilora purchases. By completing a purchase, you also agree to Dodo Payments terms of service and privacy policy, available at{' '}
          <a href="https://dodopayments.com">dodopayments.com</a>. Dodo Payments provides all customer payment inquiries and handles payment-related returns.
        </LegalParagraph>
        <LegalParagraph>
      ...
      <LegalSectionCard id="section-9" title="9. Refund Policy">
        <LegalParagraph>
          All refund requests are subject to Dodo Payments refund policies as Merchant of Record, in addition to the terms below. Full billing and refund details appear in our{' '}
        ...
        <LegalBulletList>
          <li>
            ...
            <a href={mail}>{QUILORA_CONTACT_EMAIL}</a> with your Dodo Payments order number.
          </li>
          <li>
        ...
        <LegalParagraph>
          Approved refunds are processed by Dodo Payments and may take 5–10 business days to appear on your statement. Nothing in this policy limits your statutory rights under applicable consumer protection law.
        </LegalParagraph>
      </LegalSectionCard>
